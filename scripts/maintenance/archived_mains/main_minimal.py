#!/usr/bin/env python3
"""
OCCUR-CAM Minimal Main Application
Minimal version without any background monitoring or refreshing.
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="OCCUR-CAM AI Authentication System (Minimal Interactive Version)",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python main_minimal.py                # Start interactive mode
  python main_minimal.py --setup       # Setup system and exit
  python main_minimal.py --camera 0    # Start with specific camera
  python main_minimal.py --debug       # Start in debug mode
        """
    )
    ...
    parser.add_argument(
        '--version', 
        action='version', 
        version='OCCUR-CAM v1.0.0 (Minimal Interactive)'
    )
    ...
    try:
        ...
        logging.info("=" * 60)
        logging.info("OCCUR-CAM AI Authentication System v1.0.0 (Minimal Interactive)")
        logging.info("=" * 60)
