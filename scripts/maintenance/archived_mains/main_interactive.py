#!/usr/bin/env python3
"""
OCCUR-CAM Interactive Main Application
Interactive version without constant refreshing.
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="OCCUR-CAM AI Authentication System (Interactive Version)",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python main_interactive.py                # Start interactive mode
  python main_interactive.py --setup       # Setup system and exit
  python main_interactive.py --camera 0    # Start with specific camera
  python main_interactive.py --debug       # Start in debug mode
        """
    )
    ...
    parser.add_argument(
        '--version', 
        action='version', 
        version='OCCUR-CAM v1.0.0 (Interactive)'
    )
    ...
    try:
        ...
        logging.info("=" * 60)
        logging.info("OCCUR-CAM AI Authentication System v1.0.0 (Interactive)")
        logging.info("=" * 60)
