#!/usr/bin/env python3
"""
OCCUR-CAM Clean Interactive Main Application
Clean version without any background monitoring or database spam.
"""
...
def show_auth_details(app: OCCURCamApplication):
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python main_clean_interactive.py                # Start interactive mode
  python main_clean_interactive.py --setup       # Setup system and exit
  python main_clean_interactive.py --camera 0    # Start with specific camera
  python main_clean_interactive.py --debug       # Start in debug mode
        """
    )
